...
if(isset($_POST['customer_phone']) && $_POST['customer_phone']!=""){
	$startement = $db->prepare("SELECT * FROM sales_order join customer ON sales_order.customer_id=customer.customer_id WHERE customer_phone LIKE :customer_phone");
		...
		<div class="col-md-12">
			<div class="original_invoice">
				<div class="panel panel-info no_margin">
				  <div class="panel-heading"><h4>Sales Order</h4></div>
						    ...
						    <div class="table-responsive">
							  <table class="table">
							    <tr style="background: #2BAEA8;">
							    	...
							    	<th style="width:62px;">Generate Delivery Receipt</th>
							    </tr>
							    <tr>
	...
	<div class="logo_section">
		...
		<div class="invoice_right">
			<div class="in_no">
				...
				<p class="right">KJDUF-<?php echo $row['sales_order_no']; ?></p>
			</div>
	...
	<div class="signer_section">
		...
		<div class="right_signer_sales pull_right">
			sales person<br>(Sign & Date)
							    	...
							    	<td><a href="sales_order_generate_invoice.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" >Generate Invoice</a></td>
