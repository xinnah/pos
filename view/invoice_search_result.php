						    ...
						    <div class="table-responsive">
							  <table class="table">
							    <tr style="background: #2BAEA8;">
							    	...
							    	<th style="width:145px;">Customer Name</th>
							    	<th style="width:145px;">Customer Phone</th>
	...
	<div class="logo_section">
		...
		<div class="invoice_right">
			<div class="in_no">
				...
				<p class="right">KJDUF-<?php echo $row['invoice_no']; ?></p>
			</div>
		    ...
		    <div class="table-responsive">
			  <table class="table table-striped">
			    ...
			    <tr>
			    	...
			    	<td colspan="1"><?php echo $row['vat']; ?></td>
			    </tr>
			    <tr>
			    	<td colspan="5"style="border: 0 !important;"></td>
			    ...
			    <tr>
			    	...
			    	<td colspan="1"><?php echo $row['paid']; ?></td>
			    </tr>
			    <tr>
			    	<td colspan="5"style="border: 0 !important;"></td>
	...
	<div class="signer_section">
		...
		<div class="right_signer_sales pull_right">
			sales person<br>(Sign & Date)
							    	...
							    	<!-- <td><a href="update_quotation.php" class="btn btn-info">Update</a></td> -->
							    	<!-- <td><a href="delete_quotation.php" class="btn btn-info">Delete</a></td> -->
