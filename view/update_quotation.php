		...
		<div class="row">
			<div class="col-md-12 no_padding">
					<div class="panel panel-info no_margin">
					  <div class="panel-heading"><h4 style="text-align:center;">Update Quotation</h4></div>
					  ...
					  <form action="" method="POST">
					  	...
					  	<div class="panel-body">
							<div class="view_top_date">
								<div class="view_date">
									<div class="form-group">
									    ...
									    <div class="col-sm-9">
									      <input name="quitation_date" type="Date" class="form-control" id="inputDate3">
									    </div>
									 </div>
								</div>
								<div class="view_invoice">
									...
									<div class="form-group">
									    ...
									    <div class="col-sm-9">
									      <input name="ref_no" type="text" class="form-control" id="inputInvoice3">
									    </div>
									 </div>
								</div>
							</div><!--  -->
							<div class="view_address">
								...
								<div class="contact_parson">
									<div class="form-group">
									    ...
									    <div class="col-sm-9">
									      <input name="Person_name" type="text" class="form-control" id="inputCustomerpersonNa3">
									    </div>
								    </div>
								</div>
								<div class="contact_no">
									<div class="form-group">
									    ...
									    <div class="col-sm-9">
									      <input name="Person_no" type="tel" class="form-control" id="inputCustomerpersonN3">
									    </div>
									 </div>
								</div>
							</div><!--  -->
							...
							<a href="view_quotation.php"><button class="btn btn-success btn-lg pull-right" name="confirm_invoice">Update</button></a>
						</div>
					</form>	
					</div>
