					  ...
					  <div class="container">
					    ...
					    <div class="collapse navbar-collapse no_padding" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav">
					        ...
					        <li class=""><a href="supplier_invoices.php" data-toggle="tooltip" data-placement="bottom" title="Add"><img src="img/icon/add.png"> </a></li>
			...
			<div class="col-md-12 no_padding">
				...
				<!-- start print option -->
					...
					<div class="panel panel-info no_margin">
					  <div class="panel-heading"><h4 style="text-align:center;">Add New Supplier Invoice</h4></div>
					  	...
					  	<form action="" method="POST">
							...
							<div class="view_top_date"  style="overflow:hidden;">
								...
								<div class="view_invoice" style="width:50%;float:right;">
									...
									<div class="form-group">
									    <label for="inputInvoice3" class="col-sm-4 no_padding control-label"style="width:40%;margin-left:10px;">Supplier No. :</label>
									   
									    <div id="likes" class=""style="width:55%;float:right;">
									    	 <input type="text" name="supplier_no" value="KITV521">
										</div>
									</div> 
								</div>
							</div><!--  -->
								...
								<div class="view_a_name"style="width:100%;float:left;">
									...
									<div class="form-group">
									    ...
									    <div class="col-sm-9 "style="width: 70%;float: right;padding: 0;padding-right: 15px;">
									      <input name="customer_name" type="text" class="form-control" id="inputCustomerName3" placeholder="Supplier Name ">
									    </div>
									 </div>
								</div>
							...
							<div class="view_center_folwchart">
							      			...
							      			<table class="table table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td><input type="number" name="amount[]" id="total_1" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
													</tr>
												</tbody>
											</table>
							      		</div>
							      		...
							      		<div class='col-xs-12 col-sm-6 col-md-6 col-lg-6' style="padding-left:0">
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input value="" type="number" class="form-control" name="vatper" id="tax" placeholder="Vat" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"><div class="input-group-addon">%</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="input-group">
													<div class="input-group-addon currency">৳</div>
													<input value="" type="number" class="form-control" name="vat" id="taxAmount" placeholder="Vat" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
											...
											<div class="form-group">
												...
												<div class="input-group">
													<!-- <div class="input-group-addon currency">৳</div> -->
													<input value="" type="hidden" class="form-control" name="totalAftertax" id="totalAftertax" placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="input-group">
													<div class="input-group-addon currency">৳</div>
													<input value="" type="number" class="form-control" name="delivery_charge" id="amountPaid1" placeholder="Delivery Charge" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="input-group">
													<div class="input-group-addon currency">৳</div>
													<input value="" type="number" class="form-control" name="paid" id="amountPaid" placeholder="Amount Paid" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
												</div>
											</div>
											<div class="form-group">
								...
								<a href="view_supplier_invoices.php"><button class="btn btn-success btn-lg" name=""style="margin: 15px auto;margin-left: 323px;">Confirm</button></a>
							</div>
						</form>	
					</div><!-- end panel body -->
