				...
				<div class="col-md-12 no_padding">
					...
					<div class="panel panel-info no_margin">
						<div class="panel-heading"><h4 style="text-align:center;">Add New Sales Order</h4></div>
						  	<form action="quotation_generate_sales_order.php" method="POST">
									...
									<div class="view_date pull-left" style="width:50%;float:left;">
										<div class="form-group">
										    ...
										    <div class="col-sm-9" style="width:75%;float:right">
										      <input name="so_date" type="date" class="form-control" id="inputDate3" placeholder="Date" required>
									...
									<div class="view_invoice" style="width:50%;float:right;">
										...
										<div class="form-group">
										    ...
										    <div id="likes" class=""style="width:55%;float:right;">
										    	 <input type="text" name="sales_order_no" value="<?php echo $sales_order->show_sales_order_number(); ?>">
											</div>
										</div>
										<div class="form-group"style="width:100%;overflow:hidden;">
										    ...
										    <div class=""style="width:55%;float:right;">
										    	 <input type="text" name="quotation_no" value="<?php if(isset($quotation->quotation_no)){ echo $quotation->quotation_no;}; ?>">
											</div>
										</div>
										<div class="form-group"style="width:100%;overflow:hidden;">
										    <label for="inputR3" class="col-sm-4 no_padding control-label"style="width:40%;margin-left:10px;">Invoice Ref :</label>
										   
										    <div class=""style="width:55%;float:right;">
										    	 <input type="text" name="invoice_no" value="<?php if(isset($quotation->quotation_no)){ echo $quotation->quotation_no;}; ?>">
											</div>
										</div> 
									</div>
								</div><!--  -->
								<div class="view_address" style="overflow:hidden;">
									...
									<div class="view_a_phone"style="width:100%;float:left;">
										<div class="form-group">
										    ...
										    <div class="col-sm-9 "style="width: 70%;float: right;padding: 0;padding-right: 15px;">
										      <input name="customer['customer_phone']" type="tel" class="form-control" id="inputCustomerphone3" value="<?php if(isset($customer->customer_phone)){ echo $customer->customer_phone;} ?>" required>
									...
									<div class="view_a_address"style="width:100%;float:left;">
										<div class="form-group">
										    ...
										    <div class="col-sm-9">
										      <input name="customer['contact_person']" type="text" class="form-control" id="inputCustomerpersonNa3" value="<?php if(isset($customer->contact_person)){ echo $customer->contact_person;} ?>">
										    </div>
									    </div>
									</div>
									...
									<div class="view_a_address"style="width:100%;float:left;">
										<div class="form-group">
										    ...
										    <div class="col-sm-9">
										      <input name="customer['contact_person_no']" type="tel" class="form-control" id="inputCustomerpersonN3" value="<?php if(isset($customer->contact_person_no)){ echo $customer->contact_person_no;} ?>">
										    </div>
										 </div>
									</div>
								</div><!--  -->
								...
								<a href="view_sales_order.php"><button class="btn btn-success btn-lg" name=""style="margin: 15px auto;margin-left: 323px;">Confirm</button></a>
							</div>
						</form>	
