				...
				<div class="all_page">
					<div id="print">
						<div class="logo_section">
							...
							<div class="invoice_right">
								...
								<div class="quo">
									...
									<p class="right">5215456456</p>
								</div>
								<div class="del_rw">
									<p class="left">Delivery Receipts:</p>
									<p class="right">5156415</p>
								</div>
							</div>
						</div>
						...
						<div class="bottom_section">
							<a href="update_qutation_generate_invoice.php"><input class="btn btn-info pull-left" type="submit" value="update" name=""></a>
