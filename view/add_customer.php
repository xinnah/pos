					  		...
					  		<div class="panel-body">
								...
								<form class="form-horizontal" action="add_customer.php" method="post">
								  <div class="customer_info">
									  ...
									  <div class="form-group">
										    <label for="inputAddress3" class="col-sm-3 control-label">Customer Address :</label>
										    <div class="col-sm-9">
									  	...
									  	<div class="form-group">
										    <label for="inputslno3" class="col-sm-3 control-label">Contact Person :</label>
										    <div class="col-sm-9">
										      <input type="text" name="contact_person" class="form-control" id="inputslno3" placeholder="">
										    </div>
									  </div>
									  <div class="form-group">
										    <label for="inputcode3" class="col-sm-3 control-label">Contact Person Phone :</label>
										    <div class="col-sm-9">
								  ...
								  <button class="btn btn-success btn-lg" style="margin: 15px auto;margin-left: 323px;">Add Customer</button>
