...
<?php 
	...
	if (strtolower($_SERVER["REQUEST_METHOD"]) == "post") {
		...
		if(empty($errors)){
			$OverheadCost->createPaySalary($_POST);
		}
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 no_padding">
				...
				<!-- start print option -->
				<form action="pay_salary.php" method="post">
					<div class="panel panel-info no_margin">
					  <div class="panel-heading"><h4 style="text-align:center;">Add Pay Salary</h4></div>
					  	...
					  	<div class="panel-body">
							...
							<div class="form-group">
							    <label for="inputMonth3" class="col-sm-2 control-label">Name :</label>
							    <div class="col-sm-10">
							      <input name="notes" type="text" class="form-control" id="inputMonth3" placeholder="Name">
							...
							<input type="hidden" name="cost_label" value="Pay Salary">
