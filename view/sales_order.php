				...
				<div class="col-md-12 no_padding">
					...
					<div class="panel panel-info no_margin">
						<div class="panel-heading"><h4 style="text-align:center;">Add New Sales Order</h4></div>
						  	<form class="form-horizontal" action="sales_order.php" method="POST">
						  			...
						  			<div class="row">
						  				<div class="col-md-6 col-sm-6">
											...
											<div class="form-group">
											    ...
											    <div class="col-sm-8">
											      <input name="customer['customer_phone']" type="tel" class="form-control" placeholder="Phone " readonly>
