									...
									<div class="view_invoice" style="width:50%;float:right;">
										...
										<div class="form-group">
										    ...
										    <div id="likes" class=""style="width:55%;float:right;">
										    	 <input type="text" name="sales_order_no" class="form-control" value="<?php echo $sales_order->show_sales_order_number(); ?>"readonly>
											</div>
							      		...
							      		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
											...
											<tbody>
												<tr>
													...
													<td>
														<input type="number"min="0" name="" id="quantity_1" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly="
														readonly">
