			...
			<div class="col-md-12 no_padding">
				...
				<form action="" method="POST">
					<div class="panel panel-info no_margin">
					  <div class="panel-heading"><h4 style="text-align:center;">Update Quotation Generate Sales Order</h4></div>
							...
							<div class="view_center_folwchart">
								...
								<a href="view_qutation_generate_sales_order.php"><button class="btn btn-success btn-lg pull-right" name="confirm_invoice">Update</button></a>
						</div>
