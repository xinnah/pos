				  ...
				  <?php if(isset($error)){echo $error;} ?>
				    <form class="form-horizontal" action="" method="POST">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input name="warehouse_stock" type="number" id="wqty"  class="form-control" value="<?php echo $warehouse_stock; ?>" readonly>
					    </div>
					  </div>
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      ...
					      <input type="number" min="0" max="<?php echo $warehouse_stock;?>" name="tr_shop_qty" class="form-control"  id="shopmove" >
					    </div>
					  </div>
