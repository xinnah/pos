...
<?php 
	...
	if (strtolower($_SERVER["REQUEST_METHOD"]) == "post") {
		...
		if(empty($errors)){
			$OverheadCost->createInernetBill($_POST);
		}
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 no_padding">
				...
				<!-- start print option -->
				<form action="internet_bill.php" method="post">
					<div class="panel panel-info no_margin">
					  <div class="panel-heading"><h4 style="text-align:center;">Add Interne Bill</h4></div>
					  	<?php echo Utility::message(); ?>
					  		<div class="panel-body">
								...
								<div class="form-group">
								 ...
								 <input type="hidden" name="cost_label" value="Internet Bill">
