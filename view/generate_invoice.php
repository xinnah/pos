...
<script type="text/javascript">
	$(document).ready(function(){
		$("#customer_phone").keyup(function(){
			...
			$.ajax({
				type:"POST",
				url:"generate_invoice_search_result.php",
						...
						<div class="search_invoice">
							<form class="navbar-form" role="search">
						        <div class="form-group">
						          ...
						          <input type="text" class="form-control" name="username" placeholder="Type Customer Phone Number" id="customer_phone"><i class="fa fa-search"></i>
						        </div>
