			...
			<div class="col-md-12 no_padding">
				...
				<!-- start print option -->
					...
					<div class="panel panel-info no_margin">
					  <div class="panel-heading"><h4 style="text-align:center;">Update Supplier Invoice</h4></div>
					  	...
					  	<form action="" method="POST">
							...
							<div class="view_center_folwchart">
							      			...
							      			<table class="table table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td><input type="text" data-type="productName" name="data[Invoice][uom][]" id="uom_1" class="form-control autocomplete_txt" autocomplete="off"></td>
								...
								<a href="view_supplier_invoices.php"><button class="btn btn-success btn-lg" name="confirm_invoice"style="margin: 15px auto;margin-left: 323px;">Update</button></a>
							</div>
						</form>	
					</div><!-- end panel body -->
