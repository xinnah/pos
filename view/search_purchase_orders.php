...
<script type="text/javascript">
	$(document).ready(function(){
		$("#supplier_phone").keyup(function(){
			var supplier_phone = $("#supplier_phone").val();
			$.ajax({
				type:"POST",
				url:"view_purchase_orders.php",
						...
						<div class="search_invoice center_search_long">
							<form class="navbar-form" role="search">
						        <div class="form-group">
						          ...
						          <input type="text" class="form-control" name="username" placeholder="Type the Supplier Phone Number.." id="supplier_phone"><i class="fa fa-search"></i>
						        </div>
