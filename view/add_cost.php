...
<section class="view_container_content">
	...
	<div class="container" style="background:#fff;width:53%;float:left;margin-left:210px;">
		<div class="row">

			<div class="col-md-12 no_padding">

				<!-- start print option -->
				<form action="add_cost.php" method="post">
					<div class="panel panel-info no_margin">
					  <div class="panel-heading"><h4 style="text-align:center;">Add Cost</h4></div>
					  	<?php echo Utility::message(); ?>
					  	<div class="panel-body">
							<div class="view_top_date"  style="overflow:hidden;">
								<div class="view_date pull-left" style="width:50%;float:left;">
									<div class="form-group">
									    <label for="inputDate3" class="col-sm-3 control-label">Date :</label>
									    <div class="col-sm-9">
									      <input name="date" type="Date" class="form-control" id="inputDate3" placeholder="Date">
									    </div>
									</div>
									<div class="form-group">
									    <label for="inputName3" class="col-sm-3 control-label">Notes :</label>
									    <div class="col-sm-9">
									      <input name="notes" type="text" class="form-control" id="inputName3" placeholder="Notes">
									      <?php if(isset($errors["notes"])){echo $errors["notes"]; } ?>
									    </div>
									</div>
									<div class="form-group">
									    <label for="inputAmount3" class="col-sm-3 control-label">Amount:</label>
									    <div class="col-sm-9">
									...
									<input type="hidden" name="cost_label" value="Cost">
